...
import { Inbox, X, ArrowRight, ChevronsLeft, ChevronsRight } from 'lucide-react'
...
export function ThingsToDoDrawer({ trip, isOpen, onClose }: ThingsToDoDrawerProps) {
    ...
    <>
      ...
      <div
        ...
        className={`
          ...
          lg:relative lg:translate-x-0 lg:z-0 lg:shadow-none lg:h-auto lg:flex-shrink-0
        `}
      >
        {/* Header */}
