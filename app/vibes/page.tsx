...
import { EmojiSelector } from "@/components/vibes/EmojiSelector";
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <Card className="p-6 mb-6">
                ...
                options={[
                  {
                    value: 20,
                    emoji: "🧘",
                    label: "Recharged - took it super easy",
                  },
                  {
                    value: 40,
                    emoji: "🙂",
                    label: "Content - nice and relaxed",
                  },
                  {
                    value: 60,
                    emoji: "😅",
                    label: "Accomplished - got a lot done!",
                  },
                  {
                    value: 80,
                    emoji: "🤩",
                    label: "Epic - packed every minute",
                  },
                  {
                    value: 95,
                    emoji: "🥵",
                    label: "Spent - totally exhausted (in a good way)",
                  },
                ]}
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h2 className="text-xl font-semibold">
                How much walking are your feet up for?
              </h2>
              <EmojiSelector
                options={[
                  {
                    value: 3,
                    emoji: "🪑",
                    label: "<3k steps - minimal walking",
                  },
                  { value: 5, emoji: "🚶", label: "~5k steps - light strolls" },
                  {
                    value: 8,
                    emoji: "🚶‍♂️",
                    label: "~8k steps - moderate walking",
                  },
                  {
                    value: 12,
                    emoji: "🥾",
                    label: "~12k steps - active exploration",
                  },
                  {
                    value: 18,
                    emoji: "⛰️",
                ...
                options={[
                  {
                    value: "early",
                    emoji: "🌅",
                    label: "Early bird - sunrise activities",
                  },
                  {
                    value: "balanced",
                    emoji: "😌",
                    label: "Balanced - flexible timing",
                  },
                  {
                    value: "late",
                    emoji: "🌙",
                    label: "Night owl - late starts, evening adventures",
                  },
                ]}
              ...
              <EmojiSelector
                options={[
                  {
                    value: 1,
                    emoji: "🥪",
                    label: "Familiar - stick to what I know",
                  },
                  {
                    value: 2,
                    emoji: "🍝",
                    label: "Regional classics - local favorites",
                  },
                  {
                    value: 4,
                    emoji: "🍣",
                    label: "Adventurous - try authentic local cuisine",
                  },
                  {
                    value: 5,
                    emoji: "🧪",
                    label: "Experimental - the weirder the better!",
                  },
                ]}
                ...
                onChange={(value) =>
                  updateAnswer({
                    taste: {
                      ...answers.taste!,
                      food_adventurousness: value as number,
                    },
                  })
                }
              />
            ...
            <div className="space-y-6">
              ...
              <ThemePicker
                ...
                onChange={(themes) => {
                  ...
                  updateAnswer({
                    taste: { ...answers.taste!, theme_weights: weights },
                  });
                }}
                maxSelections={3}
              />
              ...
              <EmojiSelector
                options={[
                  {
                    value: 1,
                    emoji: "😌",
                    label: "Avoid lines - prefer off-peak times",
                  },
                  {
                    value: 3,
                    emoji: "🙂",
                    label: "Some crowds okay - mix of popular and quiet",
                  },
                  {
                    value: 5,
                    emoji: "😎",
                    label: "Big sights are fine - don't mind busy places",
                  },
                ]}
                ...
                onChange={(value) =>
                  updateAnswer({
                    logistics: {
                      ...answers.logistics!,
                      crowd_tolerance: value as number,
                    },
                  })
                }
              />
          ...
          {step === 8 && (
            <div className="space-y-6">
              <h2 className="text-xl font-semibold">
                How comfortable are you with transit?
              </h2>
              <EmojiSelector
                options={[
                  {
                    value: "rides",
                    emoji: "🚖",
                    label: "Rideshares/taxis only",
                  },
                  {
                    value: "metro",
                    emoji: "🚋",
                    label: "Metro & trams are fine",
                  },
                  {
                    value: "trains",
                    emoji: "🚆",
                    label: "Intercity trains too",
                  },
                  { value: "buses", emoji: "🚌", label: "Buses are okay" },
                  {
                    value: "all",
                    emoji: "🗺️",
                    label: "All public transit - I love it!",
                  },
                ]}
                value={(() => {
                  const modes = answers.logistics?.transit_modes_allowed || [];
                  // "rideshare" and "taxi" only
                  if (
                    modes.length === 2 &&
                    modes.includes("rideshare") &&
                    modes.includes("taxi")
                  )
                    return "rides";
                  // "metro" or "tram" (with or without rideshare)
                  if (
                    ...
                    return "metro";
                  // "metro", "tram", "train" (with or without rideshare)
                  if (modes.includes("train") && !modes.includes("bus"))
                    return "trains";
                  // "metro", "tram", "train", "bus" (with or without rideshare)
                  if (modes.includes("bus") && !modes.includes("ferry"))
                    return "buses";
                  // All modes
                  if (
                    modes.includes("metro") &&
                ...
                options={[
                  {
                    value: 0,
                    emoji: "📋",
                    label: "No surprises - I like to plan everything",
                  },
                  {
                    value: 1,
                    emoji: "🔎",
                    label: "A few twists - mix of known and new",
                  },
                  {
                    value: 2,
                    emoji: "🎁",
                    label: "Surprise me daily - I love discovering!",
                  },
                ]}
          ...
          {step === 10 && (
            <div className="space-y-6">
              <h2 className="text-xl font-semibold">
                Choose your vibe packs (optional)
              </h2>
