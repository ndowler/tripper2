            ...
            <div className="space-y-4">
              <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updatePreference("comfort", {
                        pace_score: Number(e.target.value),
                      })
                    }
                    className="flex-1"
                  />
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {preferences.comfort.pace_score <= 30
                    ? "Relaxed & slow"
                    : preferences.comfort.pace_score <= 60
                    ? "Moderate pace"
                    : "Active & intense"}
                </p>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePreference("comfort", {
                      walking_km_per_day: Number(e.target.value),
                    })
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePreference("comfort", {
                      daypart_bias: e.target.value as DaypartBias,
                    })
                  }
                  className="w-full px-3 py-2 border border-input bg-background rounded-md"
                >
                  <option value="early">
                    🌅 Early Bird - Morning activities
                  </option>
                  <option value="balanced">
                    😌 Balanced - Flexible timing
                  </option>
                  <option value="late">
                    🌙 Night Owl - Late starts, evening focus
                  </option>
                </select>
              </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePreference("taste", {
                      food_adventurousness: Number(e.target.value),
                    })
                  }
                  className="w-full px-3 py-2 border border-input bg-background rounded-md"
                >
                  ...
                  <option value={2}>
                    🍝 Regional classics - Local favorites
                  </option>
                  <option value={4}>
                    🍣 Adventurous - Try authentic local cuisine
                  </option>
                  <option value={5}>
                    🧪 Experimental - The weirder the better!
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updatePreference("taste", {
                      dietary_constraints: e.target.value
                        .split(",")
                        .map((s) => s.trim())
                        .filter(Boolean),
                    })
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {AVAILABLE_THEMES.map((theme) => {
                    const isSelected =
                      preferences.taste.theme_weights[theme.id] === 1.0;
                    return (
                      <button
                        key={theme.id}
                        type="button"
            ...
            <div className="space-y-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePreference("logistics", {
                      budget_ppd: Number(e.target.value),
                    })
                  }
                  className="w-full px-3 py-2 border border-input bg-background rounded-md"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePreference("logistics", {
                      crowd_tolerance: Number(e.target.value),
                    })
                  }
                  className="w-full px-3 py-2 border border-input bg-background rounded-md"
                >
                  <option value={1}>
                    😌 Avoid lines - Prefer off-peak times
                  </option>
                  <option value={3}>
                    🙂 Some crowds okay - Mix of popular and quiet
                  </option>
                  <option value={5}>
                    😎 Big sights are fine - Don't mind busy places
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  value={
                    preferences.logistics.transit_modes_allowed.includes(
                      "ferry"
                    )
                      ? "all"
                      : preferences.logistics.transit_modes_allowed.includes(
                  ...
                  onChange={(e) => {
                    let modes: string[] = [];
                    if (e.target.value === "rides")
                      modes = ["rideshare", "taxi"];
                    else if (e.target.value === "metro")
                ...
                >
                  ...
                  <option value="all">
                    🗺️ All public transit - I love it!
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePreference("logistics", {
                      surprise_level: Number(e.target.value) as 0 | 1 | 2,
                    })
                  }
                  className="w-full px-3 py-2 border border-input bg-background rounded-md"
                >
                  <option value={0}>
                    📋 No surprises - I like to plan everything
                  </option>
                  <option value={1}>
                    🔎 A few twists - Mix of known and new
                  </option>
                  <option value={2}>
                    🎁 Surprise me daily - I love discovering!
                  </option>
                </select>
              </div>
            </div>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {Object.entries(VIBE_PACKS).map(([name, pack]) => {
                ...
                const canSelect =
                  preferences.vibe_packs.length < 2 || isSelected;
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) =>
                    updatePreference("access", { wheelchair: e.target.checked })
                  }
                  className="w-4 h-4"
                />
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) =>
                    updatePreference("access", { low_steps: e.target.checked })
                  }
                  className="w-4 h-4"
                />
                ...
                <input
                  ...
                  onChange={(e) =>
                    updatePreference("access", {
                      motion_sickness: e.target.checked,
                    })
                  }
                  className="w-4 h-4"
                />
